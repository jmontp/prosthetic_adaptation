...
for subject in subject_names:
	...
	residual_avg = output_dict[subject] - regressor_dict[subject]@ξ_dict[subject]
	unrestricted_RSS = np.sum(np.power(residual_avg, 2))
